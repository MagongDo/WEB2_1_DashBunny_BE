...
public class MultipartHttpMessageConverter extends MappingJackson2HttpMessageConverter {
    ...
    public MultipartHttpMessageConverter(ObjectMapper objectMapper) {
        ...
        // multipart/form-data 요청만 처리
        this.setSupportedMediaTypes(List.of(MediaType.MULTIPART_FORM_DATA));
    }
...
*/
/*//*
/ 이 변환기가 application/octet-stream 요청을 처리할 수 있게 함
