...
public class OwnerCouponController {
  ...
  */
  ...
  public ResponseEntity<String> createCoupon(
    ...
    int day = createOwnerCouponRequestDto.getExpiredDay();
    StoreManagement storeManagement = validator.validateStoreId(storeId);
    OwnerCoupon ownerCoupon = createOwnerCouponRequestDto.toEntity(storeManagement);
